const countries = [
  ...
  { name: 'American Samoa', phone: '+1684', code: 'AS' },
  { name: 'Andorra', phone: '+376', code: 'AD' },
  { name: 'Angola', phone: '+244', code: 'AO' },
  { name: 'Anguilla', phone: '+1264', code: 'AI' },
  { name: 'Antarctica', phone: '+672', code: 'AQ' },
  { name: 'Antigua and Barbuda', phone: '+1268', code: 'AG' },
  ...
  { name: 'Cayman Islands', phone: '+1345', code: 'KY' },
  ...
  { name: 'Cocos [Keeling] Islands', phone: '+61', code: 'CC' },
  ...
  { name: 'Curacao', phone: '+5999', code: 'CW' },
  { name: 'Cyprus', phone: '+357', code: 'CY' },
  { name: 'Czech Republic', phone: '+420', code: 'CZ' },
  { name: 'Democratic Republic of the Congo', phone: '+243', code: 'CD' },
  { name: 'Denmark', phone: '+45', code: 'DK' },
  { name: 'Djibouti', phone: '+253', code: 'DJ' },
  { name: 'Dominica', phone: '+1767', code: 'DM' },
  { name: 'Dominican Republic', phone: '+1809,1829,1849', code: 'DO' },
  ...
  { name: 'French Southern Territories', phone: '+262', code: 'TF' },
  { name: 'Gabon', phone: '+241', code: 'GA' },
  ...
  { name: 'Grenada', phone: '+1473', code: 'GD' },
  { name: 'Guadeloupe', phone: '+590', code: 'GP' },
  { name: 'Guam', phone: '+1671', code: 'GU' },
  { name: 'Guatemala', phone: '+502', code: 'GT' },
  { name: 'Guernsey', phone: '+44', code: 'GG' },
  ...
  { name: 'Heard Island and McDonald Islands', phone: '+61', code: 'HM' },
  ...
  { name: 'Ivory Coast', phone: '+225', code: 'CI' },
  { name: 'Jamaica', phone: '+1876', code: 'JM' },
  { name: 'Japan', phone: '+81', code: 'JP' },
  { name: 'Jersey', phone: '+44', code: 'JE' },
  { name: 'Jordan', phone: '+962', code: 'JO' },
  { name: 'Kazakhstan', phone: '+76,77', code: 'KZ' },
  { name: 'Kenya', phone: '+254', code: 'KE' },
  { name: 'Kiribati', phone: '+686', code: 'KI' },
  { name: 'Kosovo', phone: '+377,381,383,386', code: 'XK' },
  ...
  { name: 'Montserrat', phone: '+1664', code: 'MS' },
  { name: 'Morocco', phone: '+212', code: 'MA' },
  { name: 'Mozambique', phone: '+258', code: 'MZ' },
  { name: 'Myanmar [Burma]', phone: '+95', code: 'MM' },
  ...
  { name: 'Norfolk Island', phone: '+672', code: 'NF' },
  { name: 'North Korea', phone: '+850', code: 'KP' },
  { name: 'North Macedonia', phone: '+389', code: 'MK' },
  { name: 'Northern Mariana Islands', phone: '+1670', code: 'MP' },
  ...
  { name: 'Pitcairn Islands', phone: '+64', code: 'PN' },
  { name: 'Poland', phone: '+48', code: 'PL' },
  { name: 'Portugal', phone: '+351', code: 'PT' },
  { name: 'Puerto Rico', phone: '+1787,1939', code: 'PR' },
  ...
  { name: 'Réunion', phone: '+262', code: 'RE' },
  { name: 'Saint Barthélemy', phone: '+590', code: 'BL' },
  { name: 'Saint Helena', phone: '+290', code: 'SH' },
  { name: 'Saint Kitts and Nevis', phone: '+1869', code: 'KN' },
  { name: 'Saint Lucia', phone: '+1758', code: 'LC' },
  { name: 'Saint Martin', phone: '+590', code: 'MF' },
  { name: 'Saint Pierre and Miquelon', phone: '+508', code: 'PM' },
  { name: 'Saint Vincent and the Grenadines', phone: '+1784', code: 'VC' },
  ...
  { name: 'Sint Maarten', phone: '+1721', code: 'SX' },
  ...
  { name: 'South Georgia and the South Sandwich Islands', phone: '+500', code: 'GS' },
  ...
  { name: 'Svalbard and Jan Mayen', phone: '+4779', code: 'SJ' },
  ...
  { name: 'São Tomé and Príncipe', phone: '+239', code: 'ST' },
  ...
  { name: 'Trinidad and Tobago', phone: '+1868', code: 'TT' },
  { name: 'Tunisia', phone: '+216', code: 'TN' },
  { name: 'Turkey', phone: '+90', code: 'TR' },
  { name: 'Turkmenistan', phone: '+993', code: 'TM' },
  { name: 'Turks and Caicos Islands', phone: '+1649', code: 'TC' },
  { name: 'Tuvalu', phone: '+688', code: 'TV' },
  { name: 'U.S. Minor Outlying Islands', phone: '+1', code: 'UM' },
  { name: 'U.S. Virgin Islands', phone: '+1340', code: 'VI' },
